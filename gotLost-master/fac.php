...
if(isset($_POST['btn']))
{
$qry=mysqli_query($conn,"select * from fregister where name='$uname' && psw='$password'");
$num=mysqli_num_rows($qry);
if($num==1)
{
$qry1=mysqli_query($conn,"select * from fregister where name='$uname' && psw='$password'");
$row=mysqli_fetch_assoc($qry1);
$_SESSION['fid']=$row['id'];
?>
<script>alert('welcome to faculty home page');
</script>
<?php
...
<form id="form1" name="form1" method="post" action="">
	   <table width="46%" border="0" align="center" style="margin:0 auto;">
		...
		<td width="39%">&nbsp;</td>
		 ...
		 <tr>
           <td>&nbsp;</td>
           <td width="24%" rowspan="2" align="center"> <a href="fregist.php">Faculty Registration</a>
             <label>
