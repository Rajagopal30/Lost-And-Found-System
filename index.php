    ...
    <main>
      <section class="discovery container section-1">
        ...
        ><br><br><br><br><br><br><br><br><br><br><br>
          ...
          <div class="shrink">
            <a class="learn-more" href="sregister.php">Register Now</a>
          </div>
        </div>
        ...
        <div class="container">
          ...
          <div class="text col-lg-6 col-md-6 col-12 w-50 pt-5 pb-5">
            ...
            <p class="mb-5">
              ...
              <b><a href="lostForm.php">LOST</a></b> section and the
              other is the
              <b><a href="foundForm.php">FOUND</a></b> section. You can
        ...
        <div class="col mx-auto align-items-center pt-5">
          ...
          >
            ...
            >
              ...
              <div class="shrink">
                <a class="learn-more px-5" href="lostform.php">Next</a>
              </div>
            </div>
          </div>
          <br><br></br>
          ...
          >
            ...
            >
              ...
              <div class="shrink">
                <a class="learn-more px-5" href="foundForm.php">Next</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row align-items-center container mx-auto py-5">
          ...
          <div class="text col-lg-6 col-md-6 col-12 w-75">
            ...
            <p class="mb-5">
              ...
              <b><a href="lostform.php">LOST</a></b> section so that we
          ...
          <div class="row testimonial-three testimonial-three--col-three">
              ...
              <div class="testimonial-inner">
                <div class="testimonial-image" itemprop="image">
                  <img
                    width="180"
                    height="180"
                    src="images/avathar4.jpg"
                  />
                </div>
                <div class="testimonial-meta mb-2">
                  <strong class="testimonial-name" itemprop="name"
                    >Krishna Gopal</strong
                  >
                </div>
                <div class="testimonial-content">
                <P><strong> Thankyou for being loyal!</strong></P>
                <li><strong>NAME:</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;A.KRISHNAGOPAL</li>
                <li><strong>CLASS:</strong> &nbsp;&nbsp;&nbsp;&nbsp;A 3 B.SC CS "D"</li>
                <li><strong>ROLLNO:</strong> &nbsp;&nbsp;&nbsp;&nbsp;205114406</li>
                <li><strong>DEPT:</strong>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; CS</li>
                <br>
                    <p>
                    Thankyou for returning the Earphones
                    Your activity results smile from the 
                    owner of the item that you have returned
                    keep doing this good activities to help
            ...
            <div class="col-md-4 testimonial-three-col">
              <div class="testimonial-inner">
                ...
                <div class="testimonial-content">
                <P><strong> Thankyou for being loyal!</strong></P>
                <li><strong>NAME:</strong>&nbsp;M.MOHAMED UMAR</li>
                <li><strong>CLASS:</strong> &nbsp;&nbsp;&nbsp;&nbsp; 3 B.SC CS "D"</li>
                <li><strong>ROLLNO:</strong> &nbsp;&nbsp;&nbsp;&nbsp;205114431</li>
                <li><strong>DEPT:</strong>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; CS</li>
                <br>
                    <p>
                    Thankyou for returning the Gold chain
                    Your activity results happiness to the 
                    owner of the item that you have returned
                    keep doing this welfare activities to help
                    many people to smile
                  </p>
                </div>
              </div>
            ...
            <div class="col-md-4 testimonial-three-col">
              <div class="testimonial-inner">
                ...
                <div class="testimonial-content">
                <P><strong> Thankyou for being loyal!</strong></P>
                <li><strong>NAME:</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S.SANTHOSH</li>
                <li><strong>CLASS:</strong> &nbsp;&nbsp;&nbsp;&nbsp; 3 B.SC CS "E"</li>
                <li><strong>ROLLNO:</strong> &nbsp;&nbsp;&nbsp;&nbsp;205114537</li>
                <li><strong>DEPT:</strong>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; CS</li>
                <br>
                    <p>
                    Thankyou for returning the smart watch
                    Your activity results peace to the owner
                    of the item that you have returned
                    keep doing this welfare activities to help
                    many people to smile
                  </p>
                </div>
    ...
    <footer id="page-footer" class="py-2 bg-dark">
      ...
      <div class="copyright">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span>Copyright &copy;</span> <span>All Rights Reserved</span>
          <span>Terms of Use</span> <span>and</span> <span>Privacy Policy</span></small>
<br>
<hr>
      <div class="favicon">
        ...
        <i class="social-media fab fa-whatsapp fa-2x"></i>
