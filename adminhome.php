...
$img=$file_name;
	$max_qry = mysqli_query($conn,"select max(id) from fregister");
		...
		$id=$max_row['max(id)']+1;
$qry=mysqli_query($conn,"insert into found1 values('$id','$name','$email','$item','$place','$date','$des','$img')");
	if($qry)
	{
        ...
        <section>
            <div class="container" id="main-container">
                ...
                <div class="container p-5 mt-5" id="form-container">
                    ...
                    <h1 class="text-center">Upload Found Details<i class="far fa-smile-beam"></i></h1>
