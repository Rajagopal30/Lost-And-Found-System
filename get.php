...
<table width="100%" align="center" border="3">
	...
	<tr>
		<td colspan="13" align="center"><strong><h3>Application Details</h3></strong></td>
  </tr>
		  ...
		  <td ><div align="center" class="style6"><strong>Function Type</strong> </div></td>
		   <td ><div align="center" class="style6"><strong>Chair</strong> </div></td>
		   <td ><div align="center" class="style6"><strong>Food</strong> </div></td>
		   <td ><div align="center" class="style6"><strong>Stage</strong> </div></td>
		    <td ><div align="center" class="style6"><strong>Dance</strong> </div></td>
			<td ><div align="center" class="style6"><strong>DJ</strong> </div></td>
			<td ><div align="center" class="style6"><strong>Peoples</strong> </div></td>
			<td ><div align="center" class="style6"><strong>Date</strong> </div></td>
			<td ><div align="center" class="style6"><strong>Email</strong> </div></td>
			<td ><div align="center" class="style6"><strong>Mobile</strong> </div></td>
			<td ><div align="center" class="style6"><strong>UserName</strong> </div></td>
		...
		<?php
		$qry=mysqli_query($conn,"select * from book where  status='' and oid='$oid'");
        ...
        <tr>
		   ...
		   <td><div align="center"><?php echo $row['function'];?></div></td>
		      <td><div align="center"><?php echo $row['chair'];?></div></td>
			  <td><div align="center"><?php echo $row['food'];?></div></td>
			 <td><div align="center"><?php echo $row['stage'];?></div></td>
			   <td><div align="center"><?php echo $row['dance'];?></div></td>
			    <td><div align="center"><?php echo $row['dj'];?></div></td>
				   <td><div align="center"><?php echo $row['peoples'];?></div></td>
			   ...
			   <td><div align="center"><?php echo $row['email'];?></div></td>
			    ...
			    <td><div align="center"><a href="accept.php?id=<?php echo $row['id'];?>">Accept</a>/<a href="reject.php?id=<?php echo $row['id'];?>">Reject</a></div></td>		 
        </tr>
